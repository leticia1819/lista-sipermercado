...
public class MainActivity extends AppCompatActivity {
    ...
    View.OnClickListener click_ck = new View.OnClickListener() {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            list_view = (ListView) findViewById(R.id.list_viw);
        ...
        lstProdutos.add(new Produto("Feijâo", false));
        lstProdutos.add(new Produto("Batata", false));
        lstProdutos.add(new Produto("Macarrão", false));*/
